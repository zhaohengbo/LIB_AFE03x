...
#if 0
void HAL_afe031_txEnable(void);
void HAL_afe031_txDisable(void);
void HAL_afe031_dacEnable(void);
void HAL_afe031_dacDisable(void);
void HAL_afe031_rxEnable(void);
void HAL_afe031_rxDisable(void);
#endif
